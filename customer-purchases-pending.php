                    ...
                    <div class="container">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link active" href="customer-purchases-pending.php">Pending
                                <?php
                                    if($pendingCounter != 0){
                                    echo "(".$pendingCounter.")";
                                    }
        ...
        <div class="prodak">
            <div class="seller-name">
                ...
                <div class="sa-products">
                    <div class="product-col row">
                        <div class="imeds-n-neym col-9">
                        ...
                        <div class="total-price-div col-3"><span>₱<?php echo number_format($val['total'], 2)?></span></div>
                    </div>
                </div>
                <?php 
                    } 
