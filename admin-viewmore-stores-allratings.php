    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-brand"> <a href="admin-account-settings.php?adminID=<?=$_SESSION['userID']?>"><i class="fas fa-user-cog"></i><span class="icon-name">Settings</span></a></li>
            </ul>
        </div>
        <div class="page-content-wrapper">
            <div class="container details-container">
                ...
                <div class="nav-div">
                    <ul class="nav">
                        <li class="nav-item active-name"><a class="nav-link active" href="admin-viewmore-stores-allratings.php?shopID=<?=$user['userID']?>">All Ratings</a></li>
                ...
                <?php
                    ...
                    if(empty($allratings)){
                ?>
                <h5 class="no-rate">No ratings yet</h5>
                <?php
                    }else{
                ?>
                <div class="table-div">
                        ...
                        <table class="datatable row-border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $ratings['firstname'].' '.$ratings['lastname']?></td>
