...
<body>
    ...
    <div class="container product-update-container">
        <form action="assets/includes/updateFuel-inc.php?fuelID=<?php echo $_GET['fuelID'] ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row profile-row">
                <div class="col-sm-12 col-md-12 col-lg-5 prod-img-col">
                    <div class="avatar">
                        <div class="avatar-bg center" id="avatar"><img class="img" style="height: 250px; width:250px;" src="<?php echo 'assets/img/products/'.$data['fuel_image'] ?>"/></div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-7 prod-details-col">
                    <div class="row">
                        <div class="col">
                            <div class="form-group mb-3"><label class="form-label">Product Name</label><input class="form-control" type="text" name="fuelType" value="<?php echo $data['fuel_type'] ?>"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-7">
                        ...
                        <div class="col-5">
                            <div class="form-group mb-3"><label class="form-label">Price</label><input class="form-control" type="decimal" name="newPrice" value="<?php echo $data['new_price'] ?>"></div>
                        </div>
                        <div class="col">
                            <div class="form-group mb-3"><input class="form-control" type="hidden" name="oldPrice" value="<?php echo $data['new_price'] ?>"></div>
                        </div>
                    </div>
