            ...
            ?>
                <div class="row g-0" id="checkout">
                    ...
                    <div class="col-auto checkout-col">
                        ...
                        ?>
                            <div class="checkout">
                                <a class="btn btn-primary" role="button" href="customer-checkout.php">Check Out</a>
                            </div>
                        <?php 
                            }else if($cartCheckedwithQuant == 0){
                        ?>
                            <div class="checkout">
                                <a class="btn btn-primary disabled" role="button" id="checkOUT">Check Out</a>
                            </div>
                        <?php
                            }
                        ?>
