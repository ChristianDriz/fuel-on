...
<head>
    ...
    <title>Fuel ON | Station Cancelled Orders</title>
    ...
    <div id="wrapper">
        ...
        <div class="page-content-wrapper"> 
            <div class="container" id="transaction-container">
                        ...
                        <nav class="navbar navbar-light navbar-expand">
                            <div class="container">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item active"><a class="nav-link active" href="store-orders-cancelled.php">Cancelled</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                $orders = $dbh->shopOrderCountCancelled($userID, $statusOne, $statusTwo, $statusThree);
                if(empty($orders)){
                ?>
