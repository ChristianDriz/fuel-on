                ...
                <div class="col-lg-6 product-info-col">
                    ...
                    <div class="row" id="Product-quantity">
                        <div class="col quantity-div">
                            ...
                            <?php if ($prod['quantity'] != 0){?>
                                <input class="form-control quant-input" type="number" name="quantity" value="1" min = 1>
                            <?php
                            }else {?> 
                                <input class="form-control quant-input" type="number" disabled value="1">
                            <?php
                            }
                            ?>
                        </div>
                        <div class="col">
                            ...
                            <p><?php echo $prod["quantity"]?> pcs available</p>       
                        </div>
                        <div class="col">
                            <label class="form-label">Sold</label>
                            <p class="stocks"><?php echo $sold?> sold</p>       
                        </div>
                    </div>
            ...
            <div class="row" id="Product-seller">
                ...
                <div class="col seller-btn-col">
                    ...
                    <div class="btns-div">
                        ...
                        <div>
                            <a class="btn view-store" role="button" href="customer-viewstore-timeline.php?stationID=<?php echo $_GET['stationID'] ?>">
