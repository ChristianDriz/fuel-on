...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Admin%20css%20files/admin-store-location.css">
</head>
<body>
    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-brand"> <a class="actives" href="admin-store-locations.php"><i class="fas fa-map-marked-alt"></i><span class="icon-name">Station Locations</span></a></li>
    ...
    <script src="assets/js/admin-mapOfstore.js"></script> 
    <script>
    <?php
